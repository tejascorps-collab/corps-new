// Curated icon registry — only the icons actually used across the app.
// Named imports are tree-shakeable, unlike `import * as Icons` which pulls the
// entire lucide-react library (~770 KB) into the initial bundle.
import {
  ...
  Info, Landmark, Layers, LayoutDashboard, LifeBuoy, LineChart, ListChecks, ListTodo,
  Loader, LogOut, Mail, MapPin, MapPinned, Megaphone, Menu, MessageCircle, Milestone,
  Minus, MoreHorizontal, MoreVertical, Paperclip, PenLine, Pencil, Percent, PieChart,
